...
export function getHelpText() {
  return [
    ...
    "• `/timezone set|show|clear`",
    "• `/reminder add|addlocal|list|remove`",
    "• `/preset add|send|list|remove`",
    "• `/nsfwguard set|list|remove`",
    "• `/schedule addtext|addembed|addfrom|list|remove|pause|resume`",
    "• `/purge media|nonadmin|all|autopurge_set|autopurge_list|autopurge_remove|msgttl_set|msgttl_list|msgttl_remove`",
    "• `/welcome set|show|preview|clear`",
    "• `/mode set|show`",
    "• `/profile set|show|clear|peek|setfor|clearfor`",
