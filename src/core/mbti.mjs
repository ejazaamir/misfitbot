export const MBTI_QUESTIONS = [
  ...
  { axis: "ei", agree: "E", text: "I quickly start conversations with new people." },
  { axis: "ei", agree: "I", text: "I prefer depth with a few close people over broad social circles." },
  { axis: "ei", agree: "E", text: "Group activities usually feel more energizing than solo activities." },
  { axis: "ei", agree: "I", text: "I often pause before responding so I can refine my thoughts." },
  ...
  { axis: "sn", agree: "S", text: "I prefer clear instructions over open-ended interpretation." },
  { axis: "sn", agree: "N", text: "I get excited by big ideas even when details are not settled yet." },
  { axis: "sn", agree: "S", text: "I notice what is happening now more than what could happen later." },
  { axis: "sn", agree: "N", text: "I naturally connect seemingly unrelated ideas." },
  ...
  { axis: "tf", agree: "T", text: "I value fair rules even when they feel impersonal." },
  { axis: "tf", agree: "F", text: "I adjust decisions when someone’s feelings are clearly hurt." },
  { axis: "tf", agree: "T", text: "I prefer objective criteria over personal preference." },
  { axis: "tf", agree: "F", text: "I focus on empathy first when resolving conflict." },
  ...
  { axis: "jp", agree: "J", text: "I feel better when my week is organized ahead of time." },
  { axis: "jp", agree: "P", text: "I often decide at the last minute as new information appears." },
  { axis: "jp", agree: "J", text: "I like finishing tasks early rather than near the deadline." },
  { axis: "jp", agree: "P", text: "I dislike strict routines and prefer spontaneous pacing." },
];
